...
#define PWRM_vRegisterWakeupCallback(name) pwrm_vRegisterWakeupCallback(&pwrm_##name##_desc)		//  pwrm_PreSleep_desc
#define PWRM_vRegisterPreSleepCallback(name) pwrm_vRegisterPreSleepCallback(&pwrm_##name##_desc)	// pwrm_Wakeup_desc
...
//	DBG_vPrintf(TRUE, "\n PWRM_eStartActivity %d ",s_u16ActivityCounter);
...
PWRM_INLINE PWRM_teStatus PWRM_eFinishActivity(void) /* [I SP001262_fr 123] */
{
    ...
    extern volatile uint16 s_u16ActivityCounter;
//	DBG_vPrintf(TRUE, "\n PWRM_eFinishActivity %d ",s_u16ActivityCounter);
