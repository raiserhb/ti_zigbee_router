...
#define ZCL_DEVICE_DONEINTERRUPT_EVENT          0x4000
  
#define ZCL_DEVICE_SEND_INFO_TIME_30S (28000+(osal_rand() & 0x00FF) * 20)
#define ZCL_DEVICE_SEND_INFO_TIME_2S (2000+(osal_rand() & 0x00FF))
