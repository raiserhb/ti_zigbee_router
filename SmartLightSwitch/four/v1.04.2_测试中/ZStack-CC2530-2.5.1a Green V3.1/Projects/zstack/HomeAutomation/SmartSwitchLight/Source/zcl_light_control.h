...
#define LIGHT_TURN_OFF_LIGHT1()       st( P0_3 = 0;)
#define LIGHT_TURN_ON_LIGHT1()        st( P0_3 = 1;)

#define LIGHT_TURN_OFF_LIGHT2()       st( P0_4 = 0;)
#define LIGHT_TURN_ON_LIGHT2()        st( P0_4 = 1;)

#define LIGHT_TURN_OFF_LIGHT3()       st( P0_6 = 0;)
#define LIGHT_TURN_ON_LIGHT3()        st( P0_6 = 1;)
