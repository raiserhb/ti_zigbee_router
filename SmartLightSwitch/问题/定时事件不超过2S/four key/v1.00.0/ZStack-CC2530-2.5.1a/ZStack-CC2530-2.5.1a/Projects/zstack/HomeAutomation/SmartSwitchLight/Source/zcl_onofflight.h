...
#define ZCL_DEVICE_DELAY_TIME (1000+(osal_rand() & 0x0FFF))
#define ZCL_DEVICE_SEND_TIME (500+(osal_rand() & 0x00FF))
#define ZCL_DEVICE_SEND_INIF_TIME (1000+(osal_rand() & 0x00FF))
