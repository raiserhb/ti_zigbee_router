...
#define ONOFFLIGHT2_ENDPOINT            0x12
#define ONOFFLIGHT3_ENDPOINT            0x13
...
#define ZCL_DEVICE_SEND_INIF_TIME_20S (45000+(osal_rand() & 0x00FF) * 20)
#define ZCL_DEVICE_SEND_INFO_TIME_5S (10000+(osal_rand() & 0x00FF) * 20)
#define ZCL_DEVICE_SEND_INFO_TIME_3S (3000+(osal_rand() & 0x00FF))
//#define ZCL_DEVICE_SEND_INIF_TIME 100

#define ZCL_DEVICE_EXIT_NETWORK_TIME     3000
...
extern SimpleDescriptionFormat_t zclOnOffLight2_SimpleDesc;
extern SimpleDescriptionFormat_t zclOnOffLight3_SimpleDesc;

extern CONST zclAttrRec_t zclOnOffLight0_Attrs[];
extern CONST zclAttrRec_t zclOnOffLight1_Attrs[];
extern CONST zclAttrRec_t zclOnOffLight2_Attrs[];
extern CONST zclAttrRec_t zclOnOffLight3_Attrs[];

extern uint8  zclOnOffLight0_OnOff;
extern uint8  zclOnOffLight1_OnOff;
extern uint8  zclOnOffLight2_OnOff;
extern uint8  zclOnOffLight3_OnOff;

extern uint8 abno_led;
extern uint8 ledcontrol;
