...
#define ZCL_DEVICE_DELAY_TIME (1000+(osal_rand() & 0x00FF))
#define ZCL_DEVICE_SEND_TIME (2000+(osal_rand() & 0x00FF))
#define ZCL_DEVICE_SEND_INIF_TIME_15S (35000+(osal_rand() & 0x00FF)*20)
